function [scores, auc] = scr_ra(path, seqs, lab, no_hmms, nb_thresh)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%   [scores, auc] = scr_ra(path, seqs, lab, no_hmms, nb_thresh)
% 
%   SCR_RA: Compute the scores of multiple HMMs soft detectors
% 
% INPUTS:
