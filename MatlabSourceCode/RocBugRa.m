function [fpr, tpr, auc, thr] = RocBugRa(scores,lab,nb_thresh)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% [fpr, tpr, auc, thr] = RocBugRa(scores,lab,nb_thresh)
% 
% RocBugRa: Computes tpr,fpr, auc and unique thresholds.
%
% INPUTS:
